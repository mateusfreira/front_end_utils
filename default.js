...
$(function(){
	...
	$(".translate_money").each(function(){$(this).html(parseFloat($(this).text()).formatMoney())});

	$(".url_parameter").each(function(){
		if($(this).attr("name"))
			$(this).val(gup($(this).attr("name")));
	});
	$(".date").datepicker();
	$(".date").each(function(){
		var value_ = $(this).val();
	...
	$(".danger").click(function(){
		if($(this).attr("data-confirm-message"))
			return confirm("Você tem certeza "+$(this).attr("data-confirm-message")+"?")		
		else
			return true;
	});
});
